...
namespace AdminPanelApi.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
     ...
     {"phone","201095986507"},
        ...
        [HttpPost("whatsapprecive")]
        public async Task<IActionResult> SendWhatsApp([FromBody] Object model)
        {
            return Ok(model);
        ...
        {
            string url = $"https://api.chat-api.com/instance396532/messages?token=hddgg2vi6pj2gle2";
